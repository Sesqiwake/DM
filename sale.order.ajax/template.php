...
if ($useDefaultMessages || !isset($arParams['MESS_PRICE_FREE']))
{
	...
	$arParams['MESS_PRICE_FREE_ESTIMATED'] = Loc::getMessage('PRICE_FREE_DEFAULT_ESTIMATED');
}
...
$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH.'/assets/css/order/order.css', true);
...
else
{
	...
	<section class="order section-offset">
        <div class="container">
          	<div class="section-header order__header">
	            <div class="section-header__wrap">
	              	<h2 class="section-title">Оформление заказа</h2>
	            </div>
            	<a href="/personal/basket/" class="btn btn-reset btn--transparent">Вернуться в корзину</a>
          	</div>
			...
			<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
				...
				<div id="bx-soa-order" class="order__wrapper" style="opacity: 0">
					...
					<div class="order__left">
						...
						<!--	REGION BLOCK	-->
						<div id="bx-soa-region" data-visited="true" class="bx-soa-section order__wrap bx-active">
							<h3 class="order__title">Покупатель</h3>
							<div class="bx-soa-section-content container-fluid"></div>
						</div>

						<!--	DELIVERY BLOCK	-->
						<div id="bx-soa-delivery" data-visited="true" class="bx-soa-section order__wrap bx-active">
							<h3 class="order__title">Доставка и оплата</h3>
							<div class="bx-soa-section-content container-fluid"></div>
						</div>

						<!--	BUYER PROPS BLOCK	-->
						<div id="bx-soa-properties" data-visited="true" class="bx-soa-section order__wrap bx-active">
							<h3 class="order__title order__title--comment">Комментарий к заказу:</h3>
							<div class="bx-soa-section-content container-fluid"></div>
						</div>
						...
						<? if ($arParams['BASKET_POSITION'] === 'after'): ?>
							<!--	BASKET ITEMS BLOCK	-->
							<div id="bx-soa-basket" data-visited="false" class="bx-soa-section" style="display: none;">
								<div class="bx-soa-section-title-container">
									<h2 class="bx-soa-section-title col-sm-9">
										<span class="bx-soa-section-title-count"></span><?=$arParams['MESS_BASKET_BLOCK_NAME']?>
									</h2>
					...
					<!--	SIDEBAR BLOCK	-->
					<div id="bx-soa-total" class="order__right">
						<div class="bx-soa-cart-total-ghost"></div>
						<div class="bx-soa-cart-total payment-info order__info"></div>
					</div>
				</div>
			</form>
